...
-- Each confirmed guest is assigned individually by name.
...
CREATE TABLE IF NOT EXISTS table_assignments (
    ...
    CONSTRAINT fk_table_assignments_attendee FOREIGN KEY (attendee_id) REFERENCES attendees(id) ON DELETE SET NULL,
...
CREATE INDEX idx_table_assignments_guest_name ON table_assignments(invitation_id, guest_name);
