...
if (!$valid) {
    ...
    echo '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">'
        ...
        . 'background:#f0ece4;color:#1a2e23;display:flex;align-items:center;'
        . 'justify-content:center;min-height:100vh;margin:0;text-align:center;}'
        . '.card{max-width:22rem;padding:2rem;background:#fff;border-radius:1rem;'
        . 'box-shadow:0 8px 30px rgba(26,46,35,.08);}'
        . 'h1{font-size:1.5rem;margin:0 0 .5rem;}'
        . 'p{color:#4a5f50;margin:0;line-height:1.5;}'
        . '</style></head><body>'
